...
<div className="robotDiagram">
  <img src="../../../img/book-image/Leonardo_Lightning_XL_Assignment_Isaac_Platform_for_Perceptio_1.jpg" alt="Humanoid Robot" style={{borderRadius:"50px", width: '900px', height: '350px', margin: '10px auto', display: 'block'}} />
</div>
