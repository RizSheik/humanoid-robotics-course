...
<div className="robotDiagram">
  <img src="../../../img/book-image/Leonardo_Lightning_XL_Introduction_to_Digital_Twin_Technology_0.jpg" alt="Humanoid Robot" style={{borderRadius:"50px", width: '900px', height: '350px', margin: '10px auto', display: 'block'}} />
</div>
